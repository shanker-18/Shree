...
const NavbarOfferPopup: React.FC<NavbarOfferPopupProps> = ({ isOpen, onClose, onClaim }) => {
  ...
  const handleLoginToClaimClick = () => {
    navigate('/login', { 
      state: { 
        returnTo: '/',
        message: 'Please login first to avail the offer: Place an order for ₹500 or more and get 15% off on the total.' 
      }
    });
    onClose();
  };
      ...
      <div className="absolute top-full right-0 mt-2 z-50">
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">Raaga Saver</h3>
            <p className="text-sm text-gray-600">15% OFF on orders ₹500+</p>
          </div>
