        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <motion.div
                    ...
                    className="p-4 border border-gray-100 rounded-xl hover:shadow-md transition-all duration-300 flex flex-col sm:flex-row sm:items-center gap-4"
                  >
                    {/* Product Image */}
                    ...
                    <div className="w-full sm:w-auto sm:ml-auto flex items-center justify-between sm:justify-end gap-4">
                      {/* Quantity Controls */}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              ...
              {/* Offer Banner */}
              {(() => { const info = getDiscountInfo(); return info.amount > 0 ? (
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    <Gift className="h-5 w-5 text-green-600" />
                    <h3 className="font-semibold text-green-800">🎉 Offer Applied!</h3>
                  </div>
                  <p className="text-green-700 text-sm">
                    You're getting <span className="font-bold">{info.percentage}% off</span> on eligible items.
                  </p>
                </div>
              ) : null; })()}
              ...
              <div className="space-y-4 mb-6">
                ...
                {getDiscount() > 0 && (() => { const info = getDiscountInfo(); return (
                  <div className="flex justify-between text-green-600">
                    <div className="flex items-center gap-1">
                      <Sparkles className="h-4 w-4" />
                      <span>{info.type || 'Order Discount'} ({info.percentage}%)</span>
                    </div>
